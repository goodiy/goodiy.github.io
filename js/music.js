...
var music=document.getElementById("mymusic");
    ...
    var musics=new Array("Exodus.mp3","song.mp3","SomebodyThatIUsedToKnow.mp3");//音乐数组
    var music_pics=new Array("000001","000002","000003");
            ...
            if(music.paused)
                {
                    ...
                    btn.style.background="url(image/music/pictures/pause.png) no-repeat 10px";//改变播放暂停键的图标
                ...
                {
                    music.pause();//停止音乐
                    btn.style.background="url(image/music/pictures/play.png) no-repeat 10px";
    ...
    //读取音乐
        function getMusic()
        {
            music.src="image/music/"+musics[musicindex];//改变音乐的SRC
            music_pic.src="image/music/pictures/"+music_pics[musicindex]+".jpg";
